...
import com.scanning.zoomscanning.R;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback, View.OnClickListener,View.OnTouchListener {
    ...
    /** ZOOM每次变动的值 */
    private static final int ZOOM_VALUE = 10;
...
//		findViewById(R.id.capture_scan_photo).setOnClickListener(this);
        ...
        zoom_small = (Button) findViewById(R.id.zoom_small);
        zoom_big = (Button) findViewById(R.id.zoom_big);
...
//        ll_bottom.getBackground().setAlpha(130);
        ...
        zoom_small.setOnClickListener(this);
...
//		viewfinderView.drawResultBitmap(barcode);
    ...
    public void onClick(View v) {
        ...
        } else if(i == R.id.zoom_small){
            setCameraZoom(-ZOOM_VALUE);
        } else if(i == R.id.zoom_big){
            setCameraZoom(ZOOM_VALUE);
        }
